...
mixin _$Deduction {
 ...
 int? get id; int? get sortOrder; String get label; double get value; String get type; String get periodicity;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,sortOrder,label,value,type,periodicity);
...
@useResult
$Res call({
 int? id, int? sortOrder, String label, double value, String type, String periodicity
});
...
/// Create a copy of Deduction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? sortOrder = freezed,Object? label = null,Object? value = null,Object? type = null,Object? periodicity = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? sortOrder,  String label,  double value,  String type,  String periodicity)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Deduction() when $default != null:
return $default(_that.id,_that.sortOrder,_that.label,_that.value,_that.type,_that.periodicity);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? sortOrder,  String label,  double value,  String type,  String periodicity)  $default,) {final _that = this;
switch (_that) {
case _Deduction():
return $default(_that.id,_that.sortOrder,_that.label,_that.value,_that.type,_that.periodicity);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? sortOrder,  String label,  double value,  String type,  String periodicity)?  $default,) {final _that = this;
switch (_that) {
case _Deduction() when $default != null:
return $default(_that.id,_that.sortOrder,_that.label,_that.value,_that.type,_that.periodicity);case _:
  return null;
...
class _Deduction implements Deduction {
   _Deduction({required this.id, required this.sortOrder, required this.label, required this.value, required this.type, required this.periodicity});
...
@override final  String periodicity;
...
/// Create a copy of Deduction
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? sortOrder = freezed,Object? label = null,Object? value = null,Object? type = null,Object? periodicity = null,}) {

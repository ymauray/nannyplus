...
mixin _$VacationPeriod {
 ...
 int get sortOrder; String get start; int? get id; String? get end;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VacationPeriod&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder)&&(identical(other.start, start) || other.start == start)&&(identical(other.id, id) || other.id == id)&&(identical(other.end, end) || other.end == end));
}
...
@useResult
$Res call({
 int sortOrder, String start, int? id, String? end
});
...
/// Create a copy of VacationPeriod
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sortOrder = null,Object? start = null,Object? id = freezed,Object? end = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int sortOrder,  String start,  int? id,  String? end)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VacationPeriod() when $default != null:
return $default(_that.sortOrder,_that.start,_that.id,_that.end);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int sortOrder,  String start,  int? id,  String? end)  $default,) {final _that = this;
switch (_that) {
case _VacationPeriod():
return $default(_that.sortOrder,_that.start,_that.id,_that.end);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int sortOrder,  String start,  int? id,  String? end)?  $default,) {final _that = this;
switch (_that) {
case _VacationPeriod() when $default != null:
return $default(_that.sortOrder,_that.start,_that.id,_that.end);case _:
  return null;
...
class _VacationPeriod implements VacationPeriod {
  const _VacationPeriod({required this.sortOrder, required this.start, this.id, this.end});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VacationPeriod&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder)&&(identical(other.start, start) || other.start == start)&&(identical(other.id, id) || other.id == id)&&(identical(other.end, end) || other.end == end));
}
...
/// Create a copy of VacationPeriod
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sortOrder = null,Object? start = null,Object? id = freezed,Object? end = freezed,}) {

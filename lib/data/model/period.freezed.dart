...
mixin _$Period {
 ...
 int get childId; String get day; TimeOfDay get to; TimeOfDay get from; int? get sortOrder; int? get id;
...
@override
int get hashCode => Object.hash(runtimeType,childId,day,to,from,sortOrder,id);
...
@useResult
$Res call({
 int childId, String day, TimeOfDay to, TimeOfDay from, int? sortOrder, int? id
});
...
/// Create a copy of Period
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? childId = null,Object? day = null,Object? to = null,Object? from = null,Object? sortOrder = freezed,Object? id = freezed,}) {
...
as TimeOfDay,from: null == from ? _self.from : from // ignore: cast_nullable_to_non_nullable
as TimeOfDay,sortOrder: freezed == sortOrder ? _self.sortOrder : sortOrder // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int childId,  String day,  TimeOfDay to,  TimeOfDay from,  int? sortOrder,  int? id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Period() when $default != null:
return $default(_that.childId,_that.day,_that.to,_that.from,_that.sortOrder,_that.id);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int childId,  String day,  TimeOfDay to,  TimeOfDay from,  int? sortOrder,  int? id)  $default,) {final _that = this;
switch (_that) {
case _Period():
return $default(_that.childId,_that.day,_that.to,_that.from,_that.sortOrder,_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int childId,  String day,  TimeOfDay to,  TimeOfDay from,  int? sortOrder,  int? id)?  $default,) {final _that = this;
switch (_that) {
case _Period() when $default != null:
return $default(_that.childId,_that.day,_that.to,_that.from,_that.sortOrder,_that.id);case _:
  return null;
...
class _Period extends Period {
   _Period({required this.childId, required this.day, required this.to, required this.from, this.sortOrder, this.id}): super._();
  

@override final  int childId;
@override final  String day;
@override final  TimeOfDay to;
@override final  TimeOfDay from;
...
/// Create a copy of Period
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? childId = null,Object? day = null,Object? to = null,Object? from = null,Object? sortOrder = freezed,Object? id = freezed,}) {
